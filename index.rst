...
Dodatkowe indeksy utworzono dla kluczy obcych najczęściej wykorzystywanych podczas łączenia tabel: kategorii i producenta produktu, klienta zamówienia oraz produktu w pozycji zamówienia. Dla płatności i wysyłki nie dodano osobnych indeksów na ``ID_Zamowienia``, ponieważ ograniczenia ``UNIQUE`` już tworzą indeksy zapewniające szybkie wyszukiwanie według identyfikatora zamówienia.
